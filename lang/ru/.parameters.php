<?
$MESS["ITD_YM_PARAM_TYPE_MAP_NAME"]				 = "Откуда брать информацию";
$MESS["ITD_YM_PARAM_TYPE_MAP_LIST_IBLOCK"]		 = "Инфоблок";
$MESS["ITD_YM_PARAM_TYPE_MAP_LIST_COMPONENT"]	 = "Компонент";
$MESS["ITD_YM_PARAM_ADRESA_NAME"]				 = "Список адресов";
$MESS["ITD_YM_PARAM_IBLOCK_PROPERTY_NAME"]		 = "Код свойства инфоблока с адресом";
$MESS["ITD_YM_PARAM_WIDTH_MAP_NAME"]			 = "Ширина карты";
$MESS["ITD_YM_PARAM_HEIGHT_MAP_NAME"]			 = "Высота карты";
$MESS["ITD_YM_PARAM_CENTER_MAP_NAME"]			 = "Центр карты в этом месте";
$MESS["ITD_YM_PARAM_ZOOM_MAP_NAME"]				 = "Коэфицент увеличения карты";
